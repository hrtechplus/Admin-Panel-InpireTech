...
function AddOrder() {
  ...
  const sendData = (e) => {
    ...
    axios
      .post("http://localhost:5001/order/add", newOrder)
      .then(() => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm("service_emxur9p", "template_7o4wl1g", form.current, {
    ...
    >
      ...
      >
        <form ref={form} onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label style={{ width: "100%" }} htmlFor="date">
              Date
            </label>
            <DatePicker
          ...
          <div className="form-group">
            ...
            />
            {errors.bname && (
              <div className="invalid-feedback">{errors.bname}</div>
            )}
          </div>
          <div className="form-group">
          ...
          <button
            style={{ cursor: "pointer", width: "100%", marginTop: "20px" }}
            type="submit"
