...
function AddItems() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(
      "http://localhost:5001/inventoryPanel/addItems",
      {
        method: "POST",
  ...
  return (
    <>
      <SlideBar />
      <Container>
        <Text fontSize="4xl" paddingTop="24px">
          Add an item
        </Text>
        ...
        >
          <Form onSubmit={handleSubmit}>
            ...
            <FormControl marginBottom="12px" isRequired>
              ...
              />
              <FormHelperText>
                Item ID Pattern: Two uppercase letters and numbers
              </FormHelperText>
            </FormControl>
            ...
            <Button type="submit" colorScheme="blue" onClick={imageUpload}>
              Add
            </Button>
          </Form>
        </Box>
